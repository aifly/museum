var imgs = {
	...
	zhugewuhou:'./assets/images/zhugewuhou.png',
...
window.culturalRelicsList = [//文物列表
	{
		...
		title: '镇馆之宝——明“丁未夏日时大彬制”鼓腹圆柄曲流卧底圆钮紫砂盖壶',
		content: '明“丁未夏日时大彬制”鼓腹圆柄曲流卧底圆钮紫砂盖壶。壶高8.8厘米、口径5.8厘米，系明墓随葬品。1987年5月山西省晋城市泽州县大阳镇陡坡村明崇祯5年张光奎墓出土。壶为紫泥夹砂胎，胎色紫褐，手感温润，造型为溜肩、圆腹、三弯流，平底内凹。算珠形盖纽。壶盖玉壶身合缝严密，流、口部中线与执把成一线。壶底阴刻竖排双行楷书刻款：“丁未夏日 时大彬制”。',
		image:imgs.zishagaihu,
		key:'jincheng'
	},{
		title: '西汉玉仙人奔马',
		content: '咸阳博物院三大镇馆之宝之首。|高7厘米，长8.9厘米。|新疆和田羊脂玉，玉马呈昂首挺胸奔腾状，作成雄性，张口露齿，膛目，竖耳，胸至腹部饰双翼，四蹄腾空踏于云板之上，云头与马腿、蹄、尾相连，背骑羽人，肩与臀部饰羽翅，人面兽耳，长发，一手扶马颈，一手拿灵芝。|此件玉器是汉圆雕玉器的极品，为研究中国古代的玉雕艺术提供了珍贵的资料。',
		image:imgs.xianrenbenma,
		key:'xianyang'
	},{
		title: '清“道光十五年佛山造六千司马斤”前膛铁炮',
		content: '清道光十五年（1835年）广东佛山铸造。重6000司马斤，通长276厘米，内膛径16厘米，外膛径50厘米。前装滑膛铁炮，前细后丰，炮身分六节合铸而成，铸造较粗糙，上有5道箍环，两侧有圆柱形炮耳，尾部有圆钮，炮身第二节正背两面均铸有相同的铭文十二行共119个字：“道光十五年夏月 太子少保头品顶戴兵部尚书 两广总督世袭一等轻车都尉卢制 督标中协恒 署督标中协福 署广州协尚 监督 署广州协左营都司推升 福建建宁镇左营游击黄廷彪 署督标右营参将洪发科 署广州协右营守备刘得升 监造 六千斤炮食药十五斤子十五斤 禅山炉户李陈霍等制造”。|1957年8月在虎门太平贵立街发掘出土。该铁炮体量大，铭文清晰，制造地点、年代以及出土地点明确，对于鸦片战争前清政府海防研究具有重要的历史价值。该铁炮是在鸦片战争前，关天培修筑虎门炮台防御工事时，由佛山的炉户制造的大型前膛铁炮，用于武装虎门炮台，在鸦片战争期间抗击英国侵略军中发挥了重要作用。',
		image:imgs.qiantangtiepao,
		key:'dongguanshi'
	},{
		title: '“镇馆之宝”唐代昆山片玉石磨',
		content: '石磨于1954年在惠东县梁化镇花树下水库出土。石磨为昆山玉质地，高29.9cm，口径20cm，底径45cm。|“石磨制作工艺精湛，雕有精美的云纹、覆莲纹，代表了唐代石磨较高的制作技艺。”钟雪平介绍，此石磨整体呈浅铁红色，形制与现代石磨相似，由上下两部分组成。上半部分为圆柱形，上阳刻“昆山片玉”四字，外璧中饰一圆形方孔钱币状浮雕，方孔正好为推磨把手，其对称处高浮雕一覆式莲花，作辅助推磨之用；下半部分磨心高于磨流外沿，外璧作弧腹内收，壁上刻开窗卷草纹一周，饼形足稍凹，上刻纵向曲线纹一周。',
		image:imgs.yushimo,
		key:'huizhou'
	},{
		title: '元青花梅纹净水瓶',
		content: '青花瓷被誉为中国的“国瓷”。它起源于我国的元代，以其白地蓝花、色彩艳丽、装饰纹样精美、造型优美、无铅无毒、耐酸耐磨而被列为景德镇四大传统名瓷之一。|元青花在中外文化交流史中也占有重要地位，受到世界人民的喜爱和赞赏，影响之广泛、深远、持久，无一器物可与之比肩。据统计，青花瓷的全球存世量仅四百多件，土耳其伊斯坦布尔、伊朗德黑兰、埃及开罗以及美国、英国、日本等国家的博物馆收藏有二百余件，国内考古出土和博物馆收藏二百余件。国内青花瓷藏品中江西全省有48件（2007年统计），萍乡有12件（14单件）。由于元青花的存世量极少，且多为精美瓷器，受到研究、收藏者们的青睐。',
		image:imgs.wenjingshuiping,
		key:'pingxiang'
	},{
		title: '南宋剔犀如意云纹三层六出葵形盒 ',
		content: '通高15.7厘米，盖高2.8厘米，首层外壁高2.3厘米，中层外壁高5.31厘米， 底层外壁高5.3厘米，直径15厘米。|木胎，六边葵形，三层一盖，有子母口，盖底扣合严密，平底，浅足根。盖面外围饰八个如意云纹，中间四个，正中留出一个方形，中间呈“癸”字形图案，有些空下“￥”字形图案；盖外壁饰灵芝形图案，与首层外壁对称，每边各二对；中层与底层外壁对称，每边内有如意纹与灵芝纹各二对。器外表髹棕褐色漆，表面光亮。器内髹黑色漆，光亮。|它是全世界迄今为止发现最早的有纪年的雕漆制品，为雕漆的起源提供了有力实证。',
		image:imgs.kuixinghe,
		key:'fuzhoushi'
	},{
		title: '铸客大鼎',
		content: '战国|通高113厘米，口径87厘米|又名“楚大鼎”，是战国晚期楚国青铜饪食器，也是迄今为止东周时期最大最重的青铜圆鼎。圆口平唇、圜底、双耳、蹄足，鼎口平沿处刻铭文十二字，前足膝部和左腹下外壁各刻“安邦”二字。大鼎气势雄伟、体量巨大，造型设计体现了力与美的结合，呈现其主人拔山盖世的雄心壮志。',
		image:imgs.zhukedading,
		key:'anhui' 
	},{
		title: '东晋孟府君墓志砖',
		content: '这套墓志砖共分5块，每块砖长35厘米，宽17厘米，厚5厘米，每块砖大小相同，上面镌刻的文字也相同，出土时分别放置在墓葬甬道的四个角和棺床前，这一点在六朝时期的墓葬中极为罕见。最令人称奇就是就是砖上的书体，有隶、楷、行等舒体兼备。|墓志砖上面镌刻的二十九个铭文，即是“泰元元年十二月十二日晋故平昌郡安丘县始兴相散骑常侍孟府君墓”，“泰元元年”，即是东晋孝武帝的年号，为公元376年，此志比王羲之的《兰亭序》诞生的年代晚了23年。墓志砖上的书体笔法灵活，或散逸洒脱，或拙重雄放，可见出自多人之手，不仅显露出当时民间书法的多姿多彩，也印证了东晋中期楷书虽未完全成熟，但已在民间流行的史实。这套墓志砖既是我国书法中隶书向楷书演变的体现，也为上世纪六十年代郭沫若、高二适两位名家关于《兰亭序》真伪之争提供了重要的佐证，是不可多得的六朝书法演变的活化石。',
		image:imgs.muzhizhuan,
		key:'maanshanshi'
	},{
		title: '宋代海船残体',
		content: '此展品为宋代文物，残长24.2米，残宽9.15米，载重量200吨，出水时便只有下甲板的部分。尖头方尾，尖底，船身扁阔，平面近似椭圆形，舷侧板为三重木板，船底板为二重木板，共有十三个隔舱，为典型的福建尖底海船。现收藏于泉州海外交通史博物馆。|1973年，在泉州湾后渚港附近的海滩下发现一艘古代沉船，经过一年的考古发掘，一艘700多年前的中国海船惊现于世。这艘宋船残长24.20米，残宽9.15米，出水时便只有下甲板的部分，船身扁阔，是典型的福建尖底海船，3桅，有13个水密隔舱，多重板船身结构，能够增强抗击疾风巨浪的能力，可以作长时间、长距离的航行，显示了当时世界最先进的造船技术。经复原，整艘船有34米长，是一艘载重量200吨以上的中等远洋帆船。这艘古船出土了香料、货物木牌签、铜铁器、陶瓷器、铜铁钱、竹麻编织物、文化用品、装饰品、果核、贝壳、动物骨骼及其他遗物，计14类69项。其中，未脱水的香料药物数量最大，约2350多千克，说明这是一艘运载着香料药物及其他商品从东南亚归航的海船。据学者研究，这艘船应该是在南宋景炎二年（1277）农历七至九月间，从海外归返泉州，正好遇上兵祸，舶商及船员各自逃命，造成船上无人管理的状态，又逢台风大水，终致沉没。',
		image:imgs.haichuancanti,//---------------------
		key:'quanzhou' 
	},{
		title: '《蜀丞相诸葛武侯祠堂碑》碑',
		content: '此碑简称“唐碑“。镌立于唐宪宗元和四年（809），裴度撰文，柳公绰书丹，鲁建镌刻，此三人皆是各自领域的佼佼者，因此此碑亦被称之为“三绝碑”。 此碑目前位于武侯祠大门与二门东侧碑亭中，有砖砌碑亭保护，雄伟肃穆。此碑由碑帽、碑身组成，无碑座。通高367厘米、宽95厘米、厚27厘米。碑帽为半圆形，高90厘米，下部同碑身同宽，两侧弧形边缘鎸纹饰，以折枝花饰为主，余镌云纹图案。碑身长方形，高277厘米，镌刻碑文，碑文分序和铭两部分，楷书，共22行，每行约50字。正文文字虽皆清晰，但除题目及上、下款三行外，其余各行上部、下部曾有补镌。碑文的内容，主要是赞颂诸葛亮的“事君之节，开国之才，立身之道，治人之术”，缅怀蜀汉遗德，感慨当世之政。|在碑的正面、碑阴的空隙处及碑的两侧题记赋诗。现存历代题刻十六则，分题诗、题跋、题记三种，其中唐人四则，宋人六则，明人四则，清人二则。',
		image:imgs.zhugewuhou,
		key:'chengdu'
	},{
		title: '东汉铜车马',
		content: '“东汉铜车马距今已两千多年，是贵州出土的国宝级珍贵文物。”袁炜说，东汉铜车是迄今为止中国汉墓中出土的车马里最精美的一个。|1975年，东汉铜车马在贵州兴义万屯汉墓出土。原物为一车一马，青铜铸造，总长1.12米，通高0.88米。马由首、尾、颈、足、躯、耳等11段装配而成。整辆车由大约300个零部件组成。|　铜车马具有古代辎车的特点。“其车厢很严密，顶棚完全封起来的，在古代，这种辎车要么是女性乘坐，要么是用来装货物。”袁炜说，汉代辎车主要供妇女乘坐，史书中多处记载皇帝的母亲、皇后或后妃出门必乘辎车。|综合墓葬的发掘情况来看，专家推测墓主可能是一女性，从葬制规格来看，属于地方统治阶级家属身份。|今生 穿越两千年的重生|如今，东汉铜车马静静伫立在贵州省博物馆三楼中心位置。很难想象，这件文物从墓中发掘出来时，已被早年垮下的墓砖压塌，所有部件都与泥土混为一体。|在发掘现场，出现过一个小插曲。当时，因为围观的人太多，挤在最前面的小孩手里拿着一个梨，一面啃一面看热闹。让人心痛的是，后面的人一挤，孩子手上的梨坠下墓中，正好砸中铜车马的一边辕杆，砰的一声闷响，辕杆瞬间断成了两截。孩子见犯了错，赶紧跑了。|难道眼睁睁地看着这件文物报废吗？ 当时，时任贵州省博物馆研究员的唐文元毛遂自荐，主动承担起了修复铜车马的任务。他虽然全程参与发掘兴义东汉铜车马，但对于修复文物只能说是门外汉。通过半年多的努力，这件铜车马经他之手穿越2000多年获得重生。|“过去老馆展陈条件有限，都是用复制品替代展出，2017年9月30日新馆开馆，这辆光芒四射的铜车马才现出‘真身’。”袁炜说。',
		...
		title: '西汉铜鎏金朱雀',
		content: '“西汉鎏金铜朱雀”，是一件鎏金的青铜神鸟，1996年出土于巢湖市放王岗汉墓中，在中国传统文化中，朱雀为吉祥之鸟，古代四大图腾之一，史书上只见有其画，而实有其立体形状者，极为罕见。朱雀饰件的出土，让我们目睹古人想象中神鸟之雄姿，领略到其文化内涵之神韵，此朱雀同属国家一级文物。',
		image:imgs.jinzhuque,
		key:'chaohushi'
	},{
		title: '玉柄铁剑',
		content: '春秋。2006年郧县五峰乡乔家院墓地出土。剑长约31、身长19.8、宽3.1、格宽2.45、玉片长4.5、宽3.3、榫孔径0.1厘米。剑身铁质，剑锋，有从，中起脊，截面呈菱形，嵌入玉质剑格中。茎为扁平长方形，玉质，乳白色，受沁有黑斑，质地细腻，半透明。茎的两端有凹榫分别与剑格和剑首的母榫套合相连，其套合连接处的中间用玉销钉加以固定。宽格，中部微鼓弧。宽扁首。剑鞘木质，其鞘尾有一梯形珌，珌为玉质，乳白色，珌的凸榫中部有一圆形小穿孔，鞘中部镶嵌一内凹弧的长方形玉片。剑茎、鞘珌通体饰云纹，内凹外弧的长方形玉片凹面光素，弧面饰阴刻云纹。据《春秋大事表•春秋列国都邑》等相关文献记载，乔家院墓地为古麇国的都城“锡穴”所在地。春秋中期，麇、楚关系极为密切，麇国曾一度为楚之盟国。但在“厥貉之会”后，麇、楚分离，麇被楚国多次讨伐，并最终在春秋晚期为楚所灭。这里的楚墓,应是灭麇后楚人入主麇地后的楚墓,乔家院这批墓葬的年代正好与文献记载相吻合。因此可以推定，玉柄铁剑的时代为春秋中晚期。',
		image:imgs.yubingtiejian,
		key:'shiyanshi'
	},{
		title: '元•龙泉窑刻花盖罐',
		content: '龙泉窑荷叶盖罐，通高32厘米，口径25.2厘米，底径19厘米，腹围102厘米。罐身圆润，胎体厚重，胎质灰白，色泽明亮，制作规整。此罐造型别致，口沿、底足露胎处有火石红，外施梅子青釉，短颈、圆肩、鼓腹，腹部刻缠枝莲花以及“美酒清香”四字，盖中央隆起，有瓜蒂形钮，边沿平缓起伏成荷叶卷曲状。龙泉窑荷叶盖罐虽承宋风，而又有新意，从造型和纹饰都体现一种时代风格。此件藏品保存完好，曾在美国大都会博物馆展出。馆藏一级文物。',
		image:imgs.kehuagaiguan,
		key:'anhui'
	},{
		title: '铜奔马',
		content: '东汉，武威市雷台汉墓出土，通高34.5厘米，长45厘米，宽13.1厘米，重7.3千克。造型矫健精美，作昂首嘶鸣、疾足奔驰状。塑造者摄取了奔马三组腾空、一足超越飞鸟的刹那瞬间。让飞鸟回首惊顾，更增强奔马疾速向前的动势。其全身的着力点集注于超越飞鸟的一足上，精确地掌握了力学平衡原理，具有卓越的工艺技术水平。铜奔马是按照良马式的标准去塑造的，集西域马和蒙古马种的优点于一身，特别是表现出河西走马秉赋的对侧步特征。构思巧妙，艺术造型精炼，铸铜工艺卓越。铜奔马被认为是东、西方文化交往的使者和象征，被确定为中国旅游的标志。',
		...
		title: '战国牛虎铜案',
		content: '战国牛虎铜案，是云南青铜文化艺术的杰作，也是云南省博物馆的镇馆之宝。它出土于江川李家山墓葬群中墓坑最大，随葬品最多的24号墓。器物主体为一头大牛，站立状，牛角飞翘，背部自然下落成案，尾部饰一只缩小了比例的猛虎，虎做攀爬状，张口咬住牛尾；大牛腹下中空，横向套饰一只站立状小牛。大牛与小胡用模铸造，一次成型，小牛则另铸再焊接于大牛腹下。作为滇国的一件祭器，牛虎铜案在力学和美学上都达到了极高水平，几近完美。',
		image:imgs.tongan,
		key:'yunnansheng'
	},{
		title: '元代霁蓝釉白龙纹梅瓶',
